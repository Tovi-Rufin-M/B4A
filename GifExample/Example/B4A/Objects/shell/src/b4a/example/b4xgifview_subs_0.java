...
try {
		Debug.PushSubsStack("Base_Resize (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("Initialize (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("ResizeBasedOnImage (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("SetBitmap (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("SetGif (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("SetGif2 (b4xgifview) ","b4xgifview",15,__ref.getField(false, "ba"),__ref,55);
