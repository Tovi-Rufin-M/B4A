...
try {
		Debug.PushSubsStack("Button1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,42);
...
Debug.ShouldStop(512);
 BA.debugLineNum = 43;BA.debugLine="cam.Initialize(\"\")";
Debug.ShouldStop(1024);
main._cam.runVoidMethod ("Initialize",main.processBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 44;BA.debugLine="ImageView1.SetBackgroundImage(cam.CreateSurface)";
Debug.ShouldStop(2048);
main.mostCurrent._imageview1.runVoidMethod ("SetBackgroundImageNew",(Object)((main._cam.runMethod(false,"CreateSurface",main.processBA).getObject())));
...
main._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");
 //BA.debugLineNum = 19;BA.debugLine="Private cam As Camera2";
main._cam = RemoteObject.createNew ("anywheresoftware.b4a.objects.Camera2");
