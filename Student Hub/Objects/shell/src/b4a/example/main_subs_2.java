...
try {
		Debug.PushSubsStack("AddRow (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,173);
...
Debug.locals.put("Values", _values);
 BA.debugLineNum = 173;BA.debugLine="Sub AddRow(Values() As String)";
Debug.ShouldStop(4096);
 BA.debugLineNum = 174;BA.debugLine="If Values.Length <> NumberOfColumns Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("!",_values.getField(true,"length"),BA.numberCast(double.class, main._numberofcolumns))) { 
 BA.debugLineNum = 175;BA.debugLine="Log(\"Wrong number of values.\")";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 178;BA.debugLine="Dim lastRow As Int";
Debug.ShouldStop(131072);
_lastrow = RemoteObject.createImmutable(0);Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 179;BA.debugLine="lastRow = NumberOfRows";
Debug.ShouldStop(262144);
_lastrow = _numberofrows();Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 180;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(524288);
{
final int step7 = 1;
...
_l.runMethod(false,"setPadding",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10))),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0)}));
 BA.debugLineNum = 188;BA.debugLine="Dim rc As RowCol";
Debug.ShouldStop(134217728);
_rc = RemoteObject.createNew ("b4a.example.main._rowcol");Debug.locals.put("rc", _rc);
 BA.debugLineNum = 189;BA.debugLine="rc.Initialize";
Debug.ShouldStop(268435456);
_rc.runVoidMethod ("Initialize");
 BA.debugLineNum = 190;BA.debugLine="rc.Col = i";
Debug.ShouldStop(536870912);
_rc.setField ("Col" /*RemoteObject*/ ,BA.numberCast(int.class, _i));
 BA.debugLineNum = 191;BA.debugLine="rc.Row = lastRow";
Debug.ShouldStop(1073741824);
_rc.setField ("Row" /*RemoteObject*/ ,_lastrow);
 BA.debugLineNum = 192;BA.debugLine="l.Tag = rc";
Debug.ShouldStop(-2147483648);
_l.runMethod(false,"setTag",(_rc));
 BA.debugLineNum = 193;BA.debugLine="Table.AddView(l, ColumnWidth * i, RowHeight * la";
Debug.ShouldStop(1);
...
;
 BA.debugLineNum = 195;BA.debugLine="Table.Height = NumberOfRows * RowHeight";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("btnGrades_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,108);
if (RapidSub.canDelegate("btngrades_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btngrades_click");}
 BA.debugLineNum = 108;BA.debugLine="Sub btnGrades_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 109;BA.debugLine="Drawer.LeftOpen = False";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("btnProfile_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,116);
if (RapidSub.canDelegate("btnprofile_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnprofile_click");}
 BA.debugLineNum = 116;BA.debugLine="Sub btnProfile_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 117;BA.debugLine="Drawer.LeftOpen = False";
Debug.ShouldStop(1048576);
main.mostCurrent._drawer.runClassMethod (b4a.example.b4xdrawer.class, "_setleftopen" /*RemoteObject*/ ,main.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("btnSubjects_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,112);
if (RapidSub.canDelegate("btnsubjects_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnsubjects_click");}
 BA.debugLineNum = 112;BA.debugLine="Sub btnSubjects_Click";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("header (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,152);
...
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 152;BA.debugLine="Sub header(Dir As String, Filename As String)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 153;BA.debugLine="Dim headers As List";
Debug.ShouldStop(16777216);
_headers = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("headers", _headers);
 BA.debugLineNum = 154;BA.debugLine="headers.Initialize ' FIX 1: Initialize the lis";
Debug.ShouldStop(33554432);
_headers.runVoidMethod ("Initialize");
 BA.debugLineNum = 156;BA.debugLine="List1 = StringUtils1.LoadCSV2(Dir, Filename, \"";
Debug.ShouldStop(134217728);
main.mostCurrent._list1 = main._stringutils1.runMethod(false,"LoadCSV2",(Object)(_dir),(Object)(_filename),(Object)(BA.ObjectToChar(",")),(Object)(_headers));
 BA.debugLineNum = 157;BA.debugLine="NumberOfColumns = headers.Size";
Debug.ShouldStop(268435456);
main._numberofcolumns = _headers.runMethod(true,"getSize");
 BA.debugLineNum = 158;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns ' upd";
Debug.ShouldStop(536870912);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 159;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(1073741824);
{
final int step6 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 160;BA.debugLine="Dim l As Label";
Debug.ShouldStop(-2147483648);
_l = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("l", _l);
 BA.debugLineNum = 161;BA.debugLine="l.Initialize(\"header\")";
Debug.ShouldStop(1);
_l.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("header")));
 BA.debugLineNum = 162;BA.debugLine="l.Text = headers.Get(i) ' Read directly fr";
Debug.ShouldStop(2);
_l.runMethod(true,"setText",BA.ObjectToCharSequence(_headers.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 BA.debugLineNum = 163;BA.debugLine="l.Gravity = Gravity.LEFT";
Debug.ShouldStop(4);
_l.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"LEFT"));
 BA.debugLineNum = 164;BA.debugLine="l.TextSize = FontSize";
Debug.ShouldStop(8);
_l.runMethod(true,"setTextSize",main._fontsize);
 BA.debugLineNum = 165;BA.debugLine="l.Color = HeaderColor";
Debug.ShouldStop(16);
_l.runVoidMethod ("setColor",main._headercolor);
 BA.debugLineNum = 166;BA.debugLine="l.TextColor = HeaderFontColor";
Debug.ShouldStop(32);
_l.runMethod(true,"setTextColor",main._headerfontcolor);
 BA.debugLineNum = 167;BA.debugLine="l.Padding = Array As Int (10dip, 5dip, 0dip, 5di";
Debug.ShouldStop(64);
_l.runMethod(false,"setPadding",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}));
 BA.debugLineNum = 168;BA.debugLine="l.Tag = i";
Debug.ShouldStop(128);
_l.runMethod(false,"setTag",RemoteObject.createImmutable((_i)));
 BA.debugLineNum = 169;BA.debugLine="Table.AddView(l, ColumnWidth * i, 0, ColumnWidth";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("loadtable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,143);
if (RapidSub.canDelegate("loadtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","loadtable", _dir, _filename);}
int _i = 0;
RemoteObject _row = null;
Debug.locals.put("Dir", _dir);
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 143;BA.debugLine="Sub loadtable(Dir As String, Filename As String)";
Debug.ShouldStop(16384);
 BA.debugLineNum = 144;BA.debugLine="header(Dir, Filename)";
Debug.ShouldStop(32768);
_header(_dir,_filename);
 BA.debugLineNum = 145;BA.debugLine="For i = 0 To List1.Size - 1";
Debug.ShouldStop(65536);
{
final int step2 = 1;
...
try {
		Debug.PushSubsStack("NumberOfRows (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,198);
if (RapidSub.canDelegate("numberofrows")) { return b4a.example.main.remoteMe.runUserSub(false, "main","numberofrows");}
 BA.debugLineNum = 198;BA.debugLine="Sub NumberOfRows As Int";
Debug.ShouldStop(32);
 BA.debugLineNum = 199;BA.debugLine="Return Table.NumberOfViews / NumberOfColumns";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("SetGradient (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,203);
...
Debug.locals.put("Color2", _color2);
 BA.debugLineNum = 203;BA.debugLine="Sub SetGradient(Panel As Panel, Color1 As Int, Col";
Debug.ShouldStop(1024);
 BA.debugLineNum = 204;BA.debugLine="Dim gd As GradientDrawable";
Debug.ShouldStop(2048);
_gd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gd", _gd);
 BA.debugLineNum = 205;BA.debugLine="gd.Initialize(\"BR_TL\", Array As Int(Color1, Color";
Debug.ShouldStop(4096);
_gd.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"BR_TL")),(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {_color1,_color2})));
 BA.debugLineNum = 206;BA.debugLine="Panel.Background = gd";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("ShowHome (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,120);
if (RapidSub.canDelegate("showhome")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showhome");}
 BA.debugLineNum = 120;BA.debugLine="Sub ShowHome";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 121;BA.debugLine="ShowTable";
Debug.ShouldStop(16777216);
_showtable();
 BA.debugLineNum = 122;BA.debugLine="Panel36.Color = 0xFF1AEA00";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("ShowPage1 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,133);
if (RapidSub.canDelegate("showpage1")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showpage1");}
 BA.debugLineNum = 133;BA.debugLine="Sub ShowPage1";
Debug.ShouldStop(16);
 BA.debugLineNum = 134;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(32);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 135;BA.debugLine="pnlmain.LoadLayout(\"dashboard\")";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("ShowPage2 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,138);
if (RapidSub.canDelegate("showpage2")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showpage2");}
 BA.debugLineNum = 138;BA.debugLine="Sub ShowPage2";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("ShowTable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,125);
if (RapidSub.canDelegate("showtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showtable");}
 BA.debugLineNum = 125;BA.debugLine="Sub ShowTable";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 126;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(536870912);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 127;BA.debugLine="pnlmain.LoadLayout(\"profile\") 'layout contains th";
Debug.ShouldStop(1073741824);
main.mostCurrent._pnlmain.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("profile")),main.mostCurrent.activityBA);
 BA.debugLineNum = 128;BA.debugLine="Table = SV.Panel";
Debug.ShouldStop(-2147483648);
main.mostCurrent._table = main.mostCurrent._sv.runMethod(false,"getPanel");
 BA.debugLineNum = 129;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
Debug.ShouldStop(1);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 130;BA.debugLine="loadtable(File.DirAssets, \"citylist.csv\")";
Debug.ShouldStop(2);
