...
try {
		Debug.PushSubsStack("AddRow (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,175);
...
Debug.locals.put("Values", _values);
 BA.debugLineNum = 175;BA.debugLine="Sub AddRow(Values() As String)";
Debug.ShouldStop(16384);
 BA.debugLineNum = 176;BA.debugLine="If Values.Length <> NumberOfColumns Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("!",_values.getField(true,"length"),BA.numberCast(double.class, main._numberofcolumns))) { 
 BA.debugLineNum = 177;BA.debugLine="Log(\"Wrong number of values.\")";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 180;BA.debugLine="Dim lastRow As Int";
Debug.ShouldStop(524288);
_lastrow = RemoteObject.createImmutable(0);Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 181;BA.debugLine="lastRow = NumberOfRows";
Debug.ShouldStop(1048576);
_lastrow = _numberofrows();Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 182;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(2097152);
{
final int step7 = 1;
...
_l.runMethod(false,"setPadding",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10))),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0)}));
 BA.debugLineNum = 190;BA.debugLine="Dim rc As RowCol";
Debug.ShouldStop(536870912);
_rc = RemoteObject.createNew ("b4a.example.main._rowcol");Debug.locals.put("rc", _rc);
 BA.debugLineNum = 191;BA.debugLine="rc.Initialize";
Debug.ShouldStop(1073741824);
_rc.runVoidMethod ("Initialize");
 BA.debugLineNum = 192;BA.debugLine="rc.Col = i";
Debug.ShouldStop(-2147483648);
_rc.setField ("Col" /*RemoteObject*/ ,BA.numberCast(int.class, _i));
 BA.debugLineNum = 193;BA.debugLine="rc.Row = lastRow";
Debug.ShouldStop(1);
_rc.setField ("Row" /*RemoteObject*/ ,_lastrow);
 BA.debugLineNum = 194;BA.debugLine="l.Tag = rc";
Debug.ShouldStop(2);
_l.runMethod(false,"setTag",(_rc));
 BA.debugLineNum = 195;BA.debugLine="Table.AddView(l, ColumnWidth * i, RowHeight * la";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 197;BA.debugLine="Table.Height = NumberOfRows * RowHeight";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("btnDashBoard_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,104);
if (RapidSub.canDelegate("btndashboard_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btndashboard_click");}
 BA.debugLineNum = 104;BA.debugLine="Sub btnDashBoard_Click";
Debug.ShouldStop(128);
...
main.mostCurrent._drawer.runClassMethod (b4a.example.b4xdrawer.class, "_setleftopen" /*RemoteObject*/ ,main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 106;BA.debugLine="showdashboard";
Debug.ShouldStop(512);
_showdashboard();
...
try {
		Debug.PushSubsStack("btnGrades_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,109);
if (RapidSub.canDelegate("btngrades_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btngrades_click");}
 BA.debugLineNum = 109;BA.debugLine="Sub btnGrades_Click";
...
try {
		Debug.PushSubsStack("btnProfile_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,117);
if (RapidSub.canDelegate("btnprofile_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnprofile_click");}
 BA.debugLineNum = 117;BA.debugLine="Sub btnProfile_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 118;BA.debugLine="Drawer.LeftOpen = False";
Debug.ShouldStop(2097152);
main.mostCurrent._drawer.runClassMethod (b4a.example.b4xdrawer.class, "_setleftopen" /*RemoteObject*/ ,main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 119;BA.debugLine="showprofile";
Debug.ShouldStop(4194304);
_showprofile();
...
public static RemoteObject  _btnsubjects_click() throws Exception{
try {
		Debug.PushSubsStack("btnSubjects_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,113);
if (RapidSub.canDelegate("btnsubjects_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnsubjects_click");}
 BA.debugLineNum = 113;BA.debugLine="Sub btnSubjects_Click";
Debug.ShouldStop(65536);
...
RemoteObject _btnsubjects = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
Debug.ShouldStop(32768);
 BA.debugLineNum = 81;BA.debugLine="Dim btnDashBoard, btnGrades, btnSubjects, btnProf";
Debug.ShouldStop(65536);
...
_btnsubjects = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");Debug.locals.put("btnSubjects", _btnsubjects);
_btnprofile = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");Debug.locals.put("btnProfile", _btnprofile);
 BA.debugLineNum = 82;BA.debugLine="btnDashBoard.Initialize(\"btnHome\")";
Debug.ShouldStop(131072);
_btndashboard.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnHome")));
 BA.debugLineNum = 83;BA.debugLine="btnDashBoard.Text = \"DashBoard\"";
Debug.ShouldStop(262144);
_btndashboard.runMethod(true,"setText",BA.ObjectToCharSequence("DashBoard"));
 BA.debugLineNum = 84;BA.debugLine="btnGrades.Initialize(\"btnGrades\")";
Debug.ShouldStop(524288);
_btngrades.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnGrades")));
 BA.debugLineNum = 85;BA.debugLine="btnGrades.Text = \"Grades\"";
Debug.ShouldStop(1048576);
_btngrades.runMethod(true,"setText",BA.ObjectToCharSequence("Grades"));
 BA.debugLineNum = 86;BA.debugLine="btnSubjects.Initialize(\"btnSubjects\")";
Debug.ShouldStop(2097152);
_btnsubjects.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnSubjects")));
 BA.debugLineNum = 87;BA.debugLine="btnSubjects.Text = \"Subjects\" 'temporary text";
Debug.ShouldStop(4194304);
_btnsubjects.runMethod(true,"setText",BA.ObjectToCharSequence("Subjects"));
 BA.debugLineNum = 88;BA.debugLine="btnProfile.Initialize(\"btnProfile\")";
Debug.ShouldStop(8388608);
_btnprofile.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnProfile")));
 BA.debugLineNum = 89;BA.debugLine="btnProfile.Text = \"Profile\" 'temporary text";
Debug.ShouldStop(16777216);
_btnprofile.runMethod(true,"setText",BA.ObjectToCharSequence("Profile"));
 BA.debugLineNum = 91;BA.debugLine="For Each b As Button In Array(btnDashBoard, btnGr";
Debug.ShouldStop(67108864);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
{
final RemoteObject group10 = RemoteObject.createNewArray("Object",new int[] {4},new Object[] {(_btndashboard.getObject()),(_btngrades.getObject()),(_btnsubjects.getObject()),(_btnprofile.getObject())});
...
;
 BA.debugLineNum = 98;BA.debugLine="btnDashBoard.Top = 120dip";
Debug.ShouldStop(2);
_btndashboard.runMethod(true,"setTop",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 120))));
 BA.debugLineNum = 99;BA.debugLine="btnGrades.Top = 180dip";
Debug.ShouldStop(4);
_btngrades.runMethod(true,"setTop",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 180))));
 BA.debugLineNum = 100;BA.debugLine="btnSubjects.Top = 240dip";
Debug.ShouldStop(8);
_btnsubjects.runMethod(true,"setTop",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 240))));
 BA.debugLineNum = 101;BA.debugLine="btnProfile.Top = 300dip";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("header (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,154);
...
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 154;BA.debugLine="Sub header(Dir As String, Filename As String)";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 155;BA.debugLine="Dim headers As List";
Debug.ShouldStop(67108864);
_headers = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("headers", _headers);
 BA.debugLineNum = 156;BA.debugLine="headers.Initialize ' FIX 1: Initialize the lis";
Debug.ShouldStop(134217728);
_headers.runVoidMethod ("Initialize");
 BA.debugLineNum = 158;BA.debugLine="List1 = StringUtils1.LoadCSV2(Dir, Filename, \"";
Debug.ShouldStop(536870912);
main.mostCurrent._list1 = main._stringutils1.runMethod(false,"LoadCSV2",(Object)(_dir),(Object)(_filename),(Object)(BA.ObjectToChar(",")),(Object)(_headers));
 BA.debugLineNum = 159;BA.debugLine="NumberOfColumns = headers.Size";
Debug.ShouldStop(1073741824);
main._numberofcolumns = _headers.runMethod(true,"getSize");
 BA.debugLineNum = 160;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns ' upd";
Debug.ShouldStop(-2147483648);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 161;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(1);
{
final int step6 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 162;BA.debugLine="Dim l As Label";
Debug.ShouldStop(2);
_l = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("l", _l);
 BA.debugLineNum = 163;BA.debugLine="l.Initialize(\"header\")";
Debug.ShouldStop(4);
_l.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("header")));
 BA.debugLineNum = 164;BA.debugLine="l.Text = headers.Get(i) ' Read directly fr";
Debug.ShouldStop(8);
_l.runMethod(true,"setText",BA.ObjectToCharSequence(_headers.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 BA.debugLineNum = 165;BA.debugLine="l.Gravity = Gravity.LEFT";
Debug.ShouldStop(16);
_l.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"LEFT"));
 BA.debugLineNum = 166;BA.debugLine="l.TextSize = FontSize";
Debug.ShouldStop(32);
_l.runMethod(true,"setTextSize",main._fontsize);
 BA.debugLineNum = 167;BA.debugLine="l.Color = HeaderColor";
Debug.ShouldStop(64);
_l.runVoidMethod ("setColor",main._headercolor);
 BA.debugLineNum = 168;BA.debugLine="l.TextColor = HeaderFontColor";
Debug.ShouldStop(128);
_l.runMethod(true,"setTextColor",main._headerfontcolor);
 BA.debugLineNum = 169;BA.debugLine="l.Padding = Array As Int (10dip, 5dip, 0dip, 5di";
Debug.ShouldStop(256);
...
_l.runMethod(false,"setTag",RemoteObject.createImmutable((_i)));
 BA.debugLineNum = 171;BA.debugLine="Table.AddView(l, ColumnWidth * i, 0, ColumnWidth";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("loadtable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,145);
if (RapidSub.canDelegate("loadtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","loadtable", _dir, _filename);}
int _i = 0;
RemoteObject _row = null;
Debug.locals.put("Dir", _dir);
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 145;BA.debugLine="Sub loadtable(Dir As String, Filename As String)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 146;BA.debugLine="header(Dir, Filename)";
Debug.ShouldStop(131072);
_header(_dir,_filename);
 BA.debugLineNum = 147;BA.debugLine="For i = 0 To List1.Size - 1";
Debug.ShouldStop(262144);
{
final int step2 = 1;
...
try {
		Debug.PushSubsStack("NumberOfRows (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,200);
if (RapidSub.canDelegate("numberofrows")) { return b4a.example.main.remoteMe.runUserSub(false, "main","numberofrows");}
 BA.debugLineNum = 200;BA.debugLine="Sub NumberOfRows As Int";
Debug.ShouldStop(128);
 BA.debugLineNum = 201;BA.debugLine="Return Table.NumberOfViews / NumberOfColumns";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("SetGradient (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,205);
...
Debug.locals.put("Color2", _color2);
 BA.debugLineNum = 205;BA.debugLine="Sub SetGradient(Panel As Panel, Color1 As Int, Col";
Debug.ShouldStop(4096);
 BA.debugLineNum = 206;BA.debugLine="Dim gd As GradientDrawable";
Debug.ShouldStop(8192);
_gd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gd", _gd);
 BA.debugLineNum = 207;BA.debugLine="gd.Initialize(\"BR_TL\", Array As Int(Color1, Color";
Debug.ShouldStop(16384);
_gd.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"BR_TL")),(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {_color1,_color2})));
 BA.debugLineNum = 208;BA.debugLine="Panel.Background = gd";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("showgrades (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,135);
if (RapidSub.canDelegate("showgrades")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showgrades");}
 BA.debugLineNum = 135;BA.debugLine="Sub showgrades";
Debug.ShouldStop(64);
 BA.debugLineNum = 136;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(128);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 137;BA.debugLine="pnlmain.LoadLayout(\"dashboard\")";
Debug.ShouldStop(256);
main.mostCurrent._pnlmain.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("dashboard")),main.mostCurrent.activityBA);
...
try {
		Debug.PushSubsStack("showprofile (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,140);
if (RapidSub.canDelegate("showprofile")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showprofile");}
 BA.debugLineNum = 140;BA.debugLine="Sub showprofile";
Debug.ShouldStop(2048);
 BA.debugLineNum = 141;BA.debugLine="ShowTable";
Debug.ShouldStop(4096);
_showtable();
 BA.debugLineNum = 142;BA.debugLine="Panel36.Color = 0xFF1AEA00";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("ShowTable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,122);
if (RapidSub.canDelegate("showtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showtable");}
 BA.debugLineNum = 122;BA.debugLine="Sub ShowTable";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 123;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(67108864);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 124;BA.debugLine="pnlmain.LoadLayout(\"profile\") 'layout contains th";
Debug.ShouldStop(134217728);
main.mostCurrent._pnlmain.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("profile")),main.mostCurrent.activityBA);
 BA.debugLineNum = 125;BA.debugLine="Table = SV.Panel";
Debug.ShouldStop(268435456);
main.mostCurrent._table = main.mostCurrent._sv.runMethod(false,"getPanel");
 BA.debugLineNum = 126;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
Debug.ShouldStop(536870912);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 127;BA.debugLine="loadtable(File.DirAssets, \"citylist.csv\")";
Debug.ShouldStop(1073741824);
