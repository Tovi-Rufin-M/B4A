...
try {
		Debug.PushSubsStack("AddRow (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,177);
...
Debug.locals.put("Values", _values);
 BA.debugLineNum = 177;BA.debugLine="Sub AddRow(Values() As String)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 178;BA.debugLine="If Values.Length <> NumberOfColumns Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("!",_values.getField(true,"length"),BA.numberCast(double.class, main._numberofcolumns))) { 
 BA.debugLineNum = 179;BA.debugLine="Log(\"Wrong number of values.\")";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 182;BA.debugLine="Dim lastRow As Int";
Debug.ShouldStop(2097152);
_lastrow = RemoteObject.createImmutable(0);Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 183;BA.debugLine="lastRow = NumberOfRows";
Debug.ShouldStop(4194304);
_lastrow = _numberofrows();Debug.locals.put("lastRow", _lastrow);
 BA.debugLineNum = 184;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(8388608);
{
final int step7 = 1;
...
_l.runMethod(false,"setPadding",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10))),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0),BA.numberCast(int.class, 0)}));
 BA.debugLineNum = 192;BA.debugLine="Dim rc As RowCol";
Debug.ShouldStop(-2147483648);
_rc = RemoteObject.createNew ("b4a.example.main._rowcol");Debug.locals.put("rc", _rc);
 BA.debugLineNum = 193;BA.debugLine="rc.Initialize";
Debug.ShouldStop(1);
_rc.runVoidMethod ("Initialize");
 BA.debugLineNum = 194;BA.debugLine="rc.Col = i";
Debug.ShouldStop(2);
_rc.setField ("Col" /*RemoteObject*/ ,BA.numberCast(int.class, _i));
 BA.debugLineNum = 195;BA.debugLine="rc.Row = lastRow";
Debug.ShouldStop(4);
_rc.setField ("Row" /*RemoteObject*/ ,_lastrow);
 BA.debugLineNum = 196;BA.debugLine="l.Tag = rc";
Debug.ShouldStop(8);
_l.runMethod(false,"setTag",(_rc));
 BA.debugLineNum = 197;BA.debugLine="Table.AddView(l, ColumnWidth * i, RowHeight * la";
Debug.ShouldStop(16);
...
;
 BA.debugLineNum = 199;BA.debugLine="Table.Height = NumberOfRows * RowHeight";
Debug.ShouldStop(64);
...
_btnhome.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnHome")));
 BA.debugLineNum = 83;BA.debugLine="btnHome.Text = \"DashBoard\"";
Debug.ShouldStop(262144);
_btnhome.runMethod(true,"setText",BA.ObjectToCharSequence("DashBoard"));
...
_btntable.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnTable")));
 BA.debugLineNum = 85;BA.debugLine="btnTable.Text = \"Grades\"";
Debug.ShouldStop(1048576);
_btntable.runMethod(true,"setText",BA.ObjectToCharSequence("Grades"));
...
_btnpage1.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnPage1")));
 BA.debugLineNum = 87;BA.debugLine="btnPage1.Text = \"Subjects\" 'temporary text";
Debug.ShouldStop(4194304);
_btnpage1.runMethod(true,"setText",BA.ObjectToCharSequence("Subjects"));
...
_btnpage2.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("btnPage2")));
 BA.debugLineNum = 89;BA.debugLine="btnPage2.Text = \"Profile\" 'temporary text";
Debug.ShouldStop(16777216);
_btnpage2.runMethod(true,"setText",BA.ObjectToCharSequence("Profile"));
...
try {
		Debug.PushSubsStack("header (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,156);
...
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 156;BA.debugLine="Sub header(Dir As String, Filename As String)";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 157;BA.debugLine="Dim headers As List";
Debug.ShouldStop(268435456);
_headers = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("headers", _headers);
 BA.debugLineNum = 158;BA.debugLine="headers.Initialize ' FIX 1: Initialize the lis";
Debug.ShouldStop(536870912);
_headers.runVoidMethod ("Initialize");
 BA.debugLineNum = 160;BA.debugLine="List1 = StringUtils1.LoadCSV2(Dir, Filename, \"";
Debug.ShouldStop(-2147483648);
main.mostCurrent._list1 = main._stringutils1.runMethod(false,"LoadCSV2",(Object)(_dir),(Object)(_filename),(Object)(BA.ObjectToChar(",")),(Object)(_headers));
 BA.debugLineNum = 161;BA.debugLine="NumberOfColumns = headers.Size";
Debug.ShouldStop(1);
main._numberofcolumns = _headers.runMethod(true,"getSize");
 BA.debugLineNum = 162;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns ' upd";
Debug.ShouldStop(2);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 163;BA.debugLine="For i = 0 To NumberOfColumns - 1";
Debug.ShouldStop(4);
{
final int step6 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 164;BA.debugLine="Dim l As Label";
Debug.ShouldStop(8);
_l = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("l", _l);
 BA.debugLineNum = 165;BA.debugLine="l.Initialize(\"header\")";
Debug.ShouldStop(16);
_l.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("header")));
 BA.debugLineNum = 166;BA.debugLine="l.Text = headers.Get(i) ' Read directly fr";
Debug.ShouldStop(32);
_l.runMethod(true,"setText",BA.ObjectToCharSequence(_headers.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 BA.debugLineNum = 167;BA.debugLine="l.Gravity = Gravity.LEFT";
Debug.ShouldStop(64);
_l.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"LEFT"));
 BA.debugLineNum = 168;BA.debugLine="l.TextSize = FontSize";
Debug.ShouldStop(128);
_l.runMethod(true,"setTextSize",main._fontsize);
 BA.debugLineNum = 169;BA.debugLine="l.Color = HeaderColor";
Debug.ShouldStop(256);
_l.runVoidMethod ("setColor",main._headercolor);
 BA.debugLineNum = 170;BA.debugLine="l.TextColor = HeaderFontColor";
Debug.ShouldStop(512);
_l.runMethod(true,"setTextColor",main._headerfontcolor);
 BA.debugLineNum = 171;BA.debugLine="l.Padding = Array As Int (10dip, 5dip, 0dip, 5di";
Debug.ShouldStop(1024);
_l.runMethod(false,"setPadding",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0))),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)))}));
 BA.debugLineNum = 172;BA.debugLine="l.Tag = i";
Debug.ShouldStop(2048);
_l.runMethod(false,"setTag",RemoteObject.createImmutable((_i)));
 BA.debugLineNum = 173;BA.debugLine="Table.AddView(l, ColumnWidth * i, 0, ColumnWidth";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("loadtable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,147);
if (RapidSub.canDelegate("loadtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","loadtable", _dir, _filename);}
int _i = 0;
RemoteObject _row = null;
Debug.locals.put("Dir", _dir);
Debug.locals.put("Filename", _filename);
 BA.debugLineNum = 147;BA.debugLine="Sub loadtable(Dir As String, Filename As String)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 148;BA.debugLine="header(Dir, Filename)";
Debug.ShouldStop(524288);
_header(_dir,_filename);
 BA.debugLineNum = 149;BA.debugLine="For i = 0 To List1.Size - 1";
Debug.ShouldStop(1048576);
{
final int step2 = 1;
...
try {
		Debug.PushSubsStack("NumberOfRows (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,202);
if (RapidSub.canDelegate("numberofrows")) { return b4a.example.main.remoteMe.runUserSub(false, "main","numberofrows");}
 BA.debugLineNum = 202;BA.debugLine="Sub NumberOfRows As Int";
Debug.ShouldStop(512);
 BA.debugLineNum = 203;BA.debugLine="Return Table.NumberOfViews / NumberOfColumns";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("SetGradient (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,207);
...
Debug.locals.put("Color2", _color2);
 BA.debugLineNum = 207;BA.debugLine="Sub SetGradient(Panel As Panel, Color1 As Int, Col";
Debug.ShouldStop(16384);
 BA.debugLineNum = 208;BA.debugLine="Dim gd As GradientDrawable";
Debug.ShouldStop(32768);
_gd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gd", _gd);
 BA.debugLineNum = 209;BA.debugLine="gd.Initialize(\"BR_TL\", Array As Int(Color1, Color";
Debug.ShouldStop(65536);
_gd.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"BR_TL")),(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {_color1,_color2})));
 BA.debugLineNum = 210;BA.debugLine="Panel.Background = gd";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("ShowPage1 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,137);
if (RapidSub.canDelegate("showpage1")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showpage1");}
 BA.debugLineNum = 137;BA.debugLine="Sub ShowPage1";
Debug.ShouldStop(256);
 BA.debugLineNum = 138;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(512);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 139;BA.debugLine="pnlmain.LoadLayout(\"dashboard\")";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("ShowPage2 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,142);
if (RapidSub.canDelegate("showpage2")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showpage2");}
 BA.debugLineNum = 142;BA.debugLine="Sub ShowPage2";
Debug.ShouldStop(8192);
 BA.debugLineNum = 143;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(16384);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 144;BA.debugLine="pnlmain.LoadLayout(\"dashboard\")";
Debug.ShouldStop(32768);
main.mostCurrent._pnlmain.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("dashboard")),main.mostCurrent.activityBA);
...
try {
		Debug.PushSubsStack("ShowTable (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,129);
if (RapidSub.canDelegate("showtable")) { return b4a.example.main.remoteMe.runUserSub(false, "main","showtable");}
 BA.debugLineNum = 129;BA.debugLine="Sub ShowTable";
Debug.ShouldStop(1);
 BA.debugLineNum = 130;BA.debugLine="pnlmain.RemoveAllViews";
Debug.ShouldStop(2);
main.mostCurrent._pnlmain.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 131;BA.debugLine="pnlmain.LoadLayout(\"profile\") 'layout contains th";
Debug.ShouldStop(4);
main.mostCurrent._pnlmain.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("profile")),main.mostCurrent.activityBA);
 BA.debugLineNum = 132;BA.debugLine="Table = SV.Panel";
Debug.ShouldStop(8);
main.mostCurrent._table = main.mostCurrent._sv.runMethod(false,"getPanel");
 BA.debugLineNum = 133;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
Debug.ShouldStop(16);
main._columnwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._sv.runMethod(true,"getWidth"),main._numberofcolumns}, "/",0, 0));
 BA.debugLineNum = 134;BA.debugLine="loadtable(File.DirAssets, \"citylist.csv\")";
Debug.ShouldStop(32);
