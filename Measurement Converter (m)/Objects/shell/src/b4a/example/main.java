...
public static RemoteObject _selects = RemoteObject.declareNull("anywheresoftware.b4a.objects.SpinnerWrapper");
...
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"Button1",main.mostCurrent._button1,"EditText1",main.mostCurrent._edittext1,"Label2",main.mostCurrent._label2,"Label4",main.mostCurrent._label4,"Label6",main.mostCurrent._label6,"Label7",main.mostCurrent._label7,"Label8",main.mostCurrent._label8,"Selects",main.mostCurrent._selects,"Starter",Debug.moduleToString(b4a.example.starter.class),"xui",main._xui};
}
}